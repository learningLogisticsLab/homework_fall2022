...
class DQNAgent(object):
    ...
    def step_env(self):
        ...
        perform_random_action = np.random.uniform(0, 1) <= eps or self.t < self.learning_starts
        ...
        # HINT1: remember that self.last_obs must always point to the newest/latest observationTODOTTODOTODOODO
